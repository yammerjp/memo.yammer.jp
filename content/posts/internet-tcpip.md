...
![インターネットの構造](https://blob.yammer.jp/internet-tcpip-internet-construction.png)
...
![TCP/IP に含むプロトコルの一例](https://blob.yammer.jp/internet-tcpip-internet-protocol-suite.png)
...
![IETF のWebページ](https://blob.yammer.jp/internet-tcpip-ietf-maling-list.png)
...
![TCP/IP 標準化の手続き](https://blob.yammer.jp/internet-tcpip-tcpip-standardizatin.png)
...
![rfc2616の冒頭](https://blob.yammer.jp/internet-tcpip-rfc2616.png)
...
![OSI 参照モデルと TCP/IP 階層モデルの対応](https://blob.yammer.jp/internet-tcpip-tcpip-protocol-stack.png)
...
![実際の通信のカプセル化](https://blob.yammer.jp/internet-tcpip-encapsulation.png)
