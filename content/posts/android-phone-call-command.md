...
過去のメモなので、どの機種、環境だと利用できるのか確認していないが、[SOL26simロック解除](https://memo.basd4g.net/2020/03/27/sol26-sim-unlock/)に用いていることから、少なくとも左の記事のような環境で利用できそうである。
