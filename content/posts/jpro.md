...
date: "2022-12-02T03:04:35+09:00"
...
JavaScriptの文法をそのまま使って「標準入力のうち、itemsというキーの中の配列のtitleを5つ抽出する」ということが書けます。
...
[^implemention]: [`jpro`の実装](https://github.com/yammerjp/jpro)はいたって単純です。コードはいかなるnpm packageにも依存しておらず、たったの62行、しかもその2/3はヘルプメッセージです。やっていることは主に、先ほど示した4つの変数の準備と、クエリのeval、出力だけです。実装よりもこの記事の方が時間がかかっているくらいです。
